...
const AboutCompany = () => {
  return (
    <>
    <section className="bg-white dark:bg-gray-800 w-[1440px] "> {/* mt-[922px] */}
  <div className="w-[1170px] flex mx-auto h-96 relative">
    <img className="w-[1170px] h-96 left-0 top-0 absolute" src={about} />
   ...
   <path d="M53.8924 37.1997L28.1969 51.4799L28.6776 22.0869L53.8924 37.1997Z" fill="#DD3142"/>
    ...
    <div className="w-[542px] h-[310px] left-0 top-[51px] absolute bg-[#ffffffb3]"></div>
    <div className="left-[49px] top-[73px] absolute justify-start text-black text-5xl font-bold font-roboto">Welcome to<br/>Plumber Company</div>
    <div className="w-96 left-[49px] top-[187px] absolute justify-start text-black text-sm font-normal font-roboto">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book</div>
    <div className="w-32 h-11 left-[49px] top-[300px] absolute bg-[#DD3142] rounded-[45px]"></div>
    <div className="w-32 h-5 left-[49px] top-[310px] absolute text-center justify-start text-white text-base font-normal font-roboto underline uppercase">Learn More</div>
  </div>
